...
* feat(): Backport minor non-breaking changes from 3.X by @Voltra in https://github.com/Z3d0X/filament-fabricator/pull/241

**Full Changelog**: https://github.com/Z3d0X/filament-fabricator/compare/v2.6.1...v2.7.0
